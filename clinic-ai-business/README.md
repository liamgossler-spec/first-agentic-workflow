# 🤖 בלוטפרינט עסק מלא: סוכני AI לקליניקות אסתטיקה בישראל

הקופסה השלמה להקמת והפעלת עסק שמוכר סוכני AI (צ'אטבוטים בוואטסאפ + אינסטגרם) לקליניקות
אסתטיקה וקוסמטיקאיות בישראל. הקמה גבוהה (₪6,000–14,000) + ריטיינר חודשי (₪1,500–4,000).
**הכל מוכן למכור מחר.**
...
| קובץ | תוכן |
|------|------|
| `landing-page/index.html` | דף נחיתה פרימיום עם FOMO, יכולות, ROI, FAQ, CTA |
